...
static const char *menucmd[] = { "dmenu_run", "-fn", "JetBrainsMono Nerd Font Mono:size=12", NULL };
static const char *file[] = { "thunar", NULL};

// bright 
static const char *briup[] = {"/home/kun/.config/monster/scripts/brightness.sh", "up", NULL};
static const char *bridown[] = {"/home/kun/.config/monster/scripts/brightness.sh", "down", NULL};

// volume
static const char *volup[] = { "/home/kun/.config/monster/scripts/volume.sh", "up", NULL};
static const char *voldown[] = { "/home/kun/.config/monster/scripts/volume.sh", "down", NULL};
static const char *volmute[] = { "/home/kun/.config/monster/scripts/volume.sh", "mute", NULL};

// screenshot
static const char *shot[] = { "sh", "-c", "maim ~/Pictures/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png", NULL };
static const char *seleshot[] = { "sh", "-c", "maim -s ~/Pictures/Screenshots/$(date +%Y-%m-%d_%H-%M-%S).png", NULL};

/// pkill monster
static const char *pkillMon[] = { "pkill", "monster", NULL };
...
static Key keys[] = {
    ...
    ///
    /////////////////
    {  MOD4,             XK_l,          next_win,          {NULL}},
    {  MOD4,             XK_h,          prev_win,          {NULL}},


     
    /// RESIZE WINDOWS 
    {  MOD4|SHIFT,       XK_h,          resize_master,     {.i = -30}}, /* decrease size in px */
    {  MOD4|SHIFT,       XK_l,          resize_master,     {.i = +30}}, /* increase size in px */
    {  MOD4|SHIFT,       XK_j,          resize_stack,      {.i = -30}}, /* shrink   size in px */
    {  MOD4|SHIFT,       XK_k,          resize_stack,      {.i = +30}}, /* grow     size in px */
    ...
    // {  MOD4,             XK_l,          move_down,         {NULL}},
    // {  MOD4,             XK_h,          move_up,           {NULL}},
    ...
    {  MOD4|SHIFT,       XK_q,          quit,              {.v = pkillMon}}, /* quit with exit value 1 */


    /// OPEN APP KEYS
    {  MOD4,             XK_Return,     spawn,             {.com = termcmd}},
    {  MOD4,             XK_d,          spawn,             {.com = menucmd}},
    {  MOD4,             XK_e,          spawn,             {.com = file}},
    ...
    // {  MOD4|SHIFT,       XK_h,          moveresize,        {.v = (int []){   0,   0, -25,   0 }}}, /* width shrink  */
       ...
       /// KEYS CONTROL BRIGHTNESS AND VOLUME AND SCREENSHOTS
       ...
       { 0|SHIFT, XK_Print, spawn, {.v = seleshot }  },
